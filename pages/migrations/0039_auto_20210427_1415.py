...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='homepage',
            name='quotes',
            field=wagtail.fields.StreamField([('content', wagtail.blocks.StructBlock([('testimonial', wagtail.blocks.TextBlock(required=False)), ('author', wagtail.blocks.CharBlock(Required=False))]))]),
        ),
        migrations.AlterField(
            model_name='homepage',
