...
class PartnersPage(Page):
    ...
    def field_name_mapping():
        return {
         ...
         'affordability_cost': "Affordability Cost",
         'affordability_institutional': "Affordability Institutional",
         'app_available': "App Available",
         'adaptivity_adaptive_presentation': 'Adaptivity Adaptive Presentation',
         'adaptivity_affective_state': 'Adaptivity Affective State',
         'adaptivity_breadth_and_depth': ' Adaptivity Breadth and Depth',
         'adaptivity_customized_path': 'Adaptivity Customized Path',
         'adaptivity_instructor_control': 'Adaptivity Instructor Control',
         'adaptivity_quantitative_randomization': 'Adaptivity Quantitative',
         'adaptivity_varied_level': 'Adaptivity Varied Level',
         'admin_calendar_links': 'Admin Calendar Links',
         'admin_online_submission': 'Admin Online Submission',
         'admin_realtime_progress': 'Admin Realtime Progress',
         'admin_shared_students': 'Admin Shared Students',
         'admin_syllabus': 'Admin Syllabus',
         'assigment_outside_resources': 'Assignment Outside Resources',
         'assignment_editing': 'Assignment Editing',
         'assignment_multimedia': 'Assignment Multimedia',
         'assignment_multiple_quantitative': 'Assignment Multiple Quantitative',
         'assignment_pretest': 'Assignment Pretest',
         'assignment_scientific_structures': 'Assignment Scientific Structures',
         'assignment_summative_assessments': 'Assignment Summative Assessments',
         'autonomy_digital_badges': 'Autonomy Digital Badges',
         'autonomy_on_demand_extras': 'Autonomy On Demand Extras',
         'autonomy_self_reflection': 'Autonomy Self Reflection',
         'collaboration_peer_feedback': 'Collaboration Peer Feedback',
         'collaboration_peer_interaction': 'Collaboration Peer Interaction',
         'collaboration_teacher_learner_contact': 'Collaboration Teacher Learner Contact',
         'collaboration_tutor': 'Collaboration Tutor',
         'content_batch_uploads': 'Content Batch Uploads',
         'content_resource_sharing': 'Content Resource Sharing',
         'content_sharing_among_courses': 'Content Sharing Among Courses',
         'customization_assessement_repository': 'Customization Assessement Repository',
         'customization_create_learning_outcomes': 'Customization Create Learning Outcomes',
         'customization_reorder_content': 'Customization Reorder Content',
         'customization_reorder_learning_outcomes': 'Customization Reorder Learning Outcomes',
         'feedback_early_warning': 'Feedback Early Warning',
         'feedback_knowledge_gaps': 'Feedback Knowledge Gaps',
         'feedback_learner_progress_tasks': 'Feedback Learner Progress Tasks',
         'feedback_multipart': 'Feedback Multipart',
         'feedback_understanding': 'Feedback Understanding',
         'grading_change_scores': 'Grading Change Scores',
         'grading_class_and_student_level': 'Grading Class and Student Level',
         'grading_group_work': 'Grading Group Work',
         'grading_learning_portfolio': 'Grading Learning Portfolio',
         'grading_rubric_based': 'Grading Rubric Based',
         'grading_tolerances_sig_fig': 'Grading Tolerances SigFig',
         'interactivity_annotate': 'Interactivity Annotate',
         'interactivity_different_representations': 'Interactivity Different Representations',
         'interactivity_gaming': 'Interactivity Gaming',
         'interactivity_previous_knowledge': 'Interactivity Previous Knowledge',
         'interactivity_simulations': 'Interactivity Simulations',
         'interactivity_varying_means': 'Interactivity Varying Means',
         'LMS_analytics': 'LMS Analytics',
         'LMS_sends_grades': 'LMS Sends Grades',
         'LMS_SSO': 'LMS SSO',
         'measure_alternate_assessment': 'Measure Alternate Assessment',
         'measure_assessments_in_most': 'Measure Assessments in most',
         'measure_mapping': 'Measure Mapping',
         'reporting_competency': 'Reporting Competency',
         'reporting_student_workload': 'Reporting Student Workload',
         'scaffolding_hints': 'Scaffolding Hints',
         'scaffolding_learner_explanations': 'Scaffolding Learner Explanations',
         'scaffolding_mental_practice': 'Scaffolding Mental Practice',
         'scaffolding_narrative': 'Scaffolding Narrative',
         'scaffolding_social_intervention': 'Scaffolding Social Intervention',
         'usability_design_orients_users': 'Usability Design Orients Users',
         'usability_glossary': 'Usability Glossary',
         'usability_partial_progress': 'Usability Partial Progress',
         'accessibility_language_UI': 'Accessibility Language UI',
         'accessibility_language_content': 'Accessibility Language Content',
         'accessibility_VPAT': 'Accessibility VPAT',
         'accessibility_WCAG': 'Accessibility WCAG',
         'accessibility_universal_design': 'Accessibility Universal Design'}
