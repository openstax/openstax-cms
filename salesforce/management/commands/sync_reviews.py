...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        with Salesforce() as sf:
            ...
            command = "Select Id, Status__c, Approved_Customer_Review__c, Pending_Customer_Review__c, Partner_Response__c, Partner_Response_Date__c, Partner__c, Contact__c, Score__c, OS_Accounts_UUID__c FROM Partner_Review__c WHERE Status__c = 'Approved' OR Status__c = 'Responded'"
            ...
            for record in sf_reviews:
                try:
                    ...
                    if review.status != 'Edited' and review.status != 'Deleted':
            ...
            for review in new_reviews:
                ...
                data = {
                    ...
                    'Partner__c': review.partner.partner_sf_account_id,
