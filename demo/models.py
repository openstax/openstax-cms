...
class BookPage(Page):
    ...
    parent_page_types = ['demo.BookIndexPage']


class BookIndexRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('BookIndexPage', related_name='related_links')
