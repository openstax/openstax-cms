...
class EventBriteTest(APITestCase, TestCase):
    ...
    def test_can_check_registration_by_email(self):
        ...
        self.assertEqual(response.content.decode("utf-8"), '{"session_registered": false, "eventbrite_registered": true}')
    ...
    def test_returns_false_if_not_registered(self):
        ...
        self.assertEqual(response.content.decode("utf-8"), '{"session_registered": false, "eventbrite_registered": false}')
