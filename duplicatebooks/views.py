        ...
        if form.is_valid():
            try:
                ...
                if not num_failed:
                    ...
                    messages.success(request, "%(uploaded)s book(s) were duplicated while %(skipped)s page(s) were skipped because they were already in the environment. %(error)s" % {'uploaded': num_uploaded, 'skipped': num_failed, 'error': response})
